...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  // });
  it ('caso o parâmetro passado não seja um número, retorna undefined', () => {
    expect(circle(NaN)).toBeUndefined();
  });
  it ('checa se o circle retorna um objeto', () => {
    expect(typeof circle(4)).toBe('object');
  });
  it ('se o objeto retornado tem 3 propriedades', () => {
    expect(circle(4)).toHaveProperty('radius', 'area', 'circumference')
  });
  it ('se a função, quando não recebe nenhum parâmetro, retorna undefined', () => {
  ...
  it ('a função retorna, num objeto, os dados corretos de um círculo de raio 3', () => {
